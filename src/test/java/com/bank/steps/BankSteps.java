...
public class BankSteps {
    ...
    public void iClickOnButtonOnThePage(String arg0) throws InterruptedException {
        Thread.sleep(2000);
        new AccountPage().clickOnDepositButtonAfterEnterAmount();
    }
    @Then("^I verify message \"([^\"]*)\"Deposit Successful\"([^\"]*)\" on the page$")
    public void iVerifyMessageDepositSuccessfulOnThePage(String arg0, String arg1) throws InterruptedException {
        Thread.sleep(2000);
    ...
    public void iClickNextOnButton(String arg0) throws InterruptedException {
        Thread.sleep(2000);
